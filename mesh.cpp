...
void get_coef_land(Eigen::MatrixX3f &coef_land) {
	FILE *fp;
	fopen_s(&fp, "D:\\sydney\\first\\code\\2017\\cal_coeffience_Q_M_u_e_3\\cal_coeffience_Q_M_u_e_3/test_coef_land_01.txt", "r");
	int num;
	fscanf_s(fp, "%d", &num);
...
void get_coef_mesh(Eigen::MatrixX3f &coef_mesh) {
	FILE *fp;
	fopen_s(&fp, "D:\\sydney\\first\\code\\2017\\cal_coeffience_Q_M_u_e_3\\cal_coeffience_Q_M_u_e_3/test_coef_mesh_01.txt", "r");
	int num;
	fscanf_s(fp, "%d", &num);
