...
const string videolvsave = "./photo_test/video/lv_mp4/lv_file_udslt/lv_mp4";

const std::string test_debug_lv_path = "./lv_file/lv_mp4_frame0.lv";// fitting_result_t66_pose_0.lv";
const string video_path = "D:\\sydney\\first\\code\\2017\\DDE\\FaceX/photo_test/video/lv_1.avi";
...
void DDE_video_test(
	...
	Target_type last_data[3];
	for (int test_round = 1; test_round < 450; test_round+=2) {
		printf("dde_round %d: \n", test_round);
