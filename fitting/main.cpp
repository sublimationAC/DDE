...
Eigen :: MatrixXf bldshps(G_iden_num,G_nShape*3*G_nVerts);
	...
	//std::string bldshps_path = "D:\\sydney\\first\\code\\2017\\deal_data_2\\deal_data/blendshape_mtln_idesvd_30.lv";

	std::string sg_vl_path = "D:\\sydney\\first\\code\\2017\\deal_data_2\\deal_data/blendshape_ide_svd_value_30.txt";
	std::string mean_mesh_path = "D:\\sydney\\first\\code\\2017\\deal_data_2\\deal_data/blendshape_mtln_mean_mesh_neutral.txt";
	...
	std::string sg_vl_path = "/home/weiliu/fitting_dde/const_file/deal_data/blendshape_ide_svd_value_77.txt";
	std::string slt_path = "../const_file/3d22d/slt_line_4_10.txt";
	std::string rect_path = "../const_file/3d22d/slt_rect_4_10.txt";
...
Eigen::MatrixX3f mean_mesh(G_nVerts, 3);
...
int main() {
	...
	//test_inner_2dland(imgs[0][0], "./server/ID24_7.txt", ide, 0, 0);
	...
	test_slt_me_2dland(imgs[0][0], "./server/test_updt_slt_dde_2d_point.txt", ide, 0, 0);
#endif
