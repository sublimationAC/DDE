...
//using ceres::Solve;
//
//float beta_l1_sum_exp = 5;
//float beta_l2_exp = 2;
//float beta_sum_user = 10;
//
...
//		//printf("- - %.6f\n", ans);
//		if (ans < (T)0) ans = -ans;
//		if (ans > (T)1) ans = ans - (T)1;
//		else ans = (T)0;
//		residual[G_land_num * 2] = ans*(T)beta_sum_user;
//
//		return true;
//	}
//
...
//	Problem problem;
//	problem.AddResidualBlock(
//		new AutoDiffCostFunction<ceres_cal_user, G_land_num * 2+1, G_iden_num-1>(
//			new ceres_cal_user(focus, ide, id_idx, exp_idx, id_point, ide_sg_vl)),
//		NULL, x_user);
//	//puts("B");
//
//	for (int i = 0; i < G_iden_num - 1; i++) {
//		problem.SetParameterLowerBound(x_user, i, -0.5);
//		problem.SetParameterUpperBound(x_user, i, 0.5);
//	}
//
//	Solver::Options options;
//
